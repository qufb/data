...
with open('test.bin', 'wb') as f:
    ...
    f.write(b'\x8a\xd8\x00') #      call       SUB_ram_0000_d800

    f.write(b'\x88\xe0\x00') #      jmp        0xe000
    f.write(b'\xff' * (0x00d800 - f.tell()))

    # wait for key pressed
    f.write(b'\xb5\x8f') #          out        KOH,0x8f
    f.write(b'\xb7\xff') #          out        KOL,0xff
    f.write(b'\xb3\x49') #          timer_set  0x49
    f.write(b'\xb9\x08') #          unk_b9     0x8
    f.write(b'\xfe') #              timer_wait
    f.write(b'\xe2\x04') #          ld         R04,KI
    f.write(b'\x18\x82\xff') #      ld#0x1     R02,0xff
    f.write(b'\x0c\x04\x02') #      tst#0x1    R02,R04
    f.write(b'\xa3\xd8\x04') #      jmp        Z,LAB_ram_0000_d804
    f.write(b'\xb5\x80') #          out        KOH,0x80
    f.write(b'\xb7\x00') #          out        KOL,0x00
    f.write(b'\xb3\x49') #          timer_set  0x49
    f.write(b'\xfe') #              timer_wait
    f.write(b'\xfe') #              timer_wait
    f.write(b'\xb5\x8f') #          out        KOH,0x8f
